...
extension Components.Organisms.MenuPanelRowView: Examplable {
    ...
    static var exampleBackgroundColor: Color { Color.Semantic.menuPageBackground }
            ...
            Components.Organisms.MenuPanelRowView(
                model:
                        .init(title: "Title",
                              ...
                              notificationMode: .number(count: 99,max: 99),
                              disclosureModel: .init({print("disclosure placholder")})
                             ){
                                 print("panel clicked")
                             }
            ))
